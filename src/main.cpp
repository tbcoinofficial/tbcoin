...
int64 nChainStartTime = 1453630515;
...
const string strMessageMagic = "TBCoin Signed Message:\n";
...
int64 GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nTime, int nHeight)
{
    ...
    if(nHeight < YEARLY_POS_BLOCK_COUNT * 1)
      ...
      nSubsidy *= 1;
    else if(nHeight < YEARLY_POS_BLOCK_COUNT * 100)
      nSubsidy /=10; //0.1%
    else
      nSubsidy = 0;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in TBCoin
    bool fStrictPayToScriptHash = true; // Always active in TBCoin
...
bool ProcessBlock(CNode* pfrom, CBlock* pblock)
{
    ...
    if (pblock->IsProofOfStake())
    {
        ...
        if (!CheckProofOfStake(pblock->vtx[1], pblock->nBits, hashProofOfStake))
        {
            ...
            //do not return here to prevent downloading stop
        }
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "TBCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "2016/01/24 The New Begin, The New Life.";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0x4a767b1226909669f1c96367caa38f4d66aebf93398ea37eb665f2ca2d1dd419"));
